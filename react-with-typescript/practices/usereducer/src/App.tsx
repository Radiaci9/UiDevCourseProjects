...
type FetchReducerActions = LoadingAction | SuccessAction | ErrorAction

function fetchReducer(state: FetchReducerState, action: FetchReducerActions): FetchReducerState {
