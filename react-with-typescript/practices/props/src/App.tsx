...
const CounterButtons = ({ setCount }: { setCount: React.Dispatch<React.SetStateAction<number>> }) => {
  return (
    <div>
      <Button
...
const Tooltip: React.FC<{ contents: React.ReactNode, style?: React.CSSProperties }> = ({ children, contents, style }) => {
...
interface MousePositionProps {
  children: (position: Position) => React.ReactElement
}

// Render Props
const MousePosition: React.FC<MousePositionProps> = ({ children }) => {
